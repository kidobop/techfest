  ...
  return (
    <div className="min-h-screen">
      <DeptHero
        ...
        imageSrc="/eee.jpg"
        imageAlt="Electrical and Electronics Engineering Cover Image"
        description="Welcome to the Electrical and Electronics Engineering department. Explore our events here."
      />
