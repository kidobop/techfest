...
import EventCard from "@/components/EventCardCE";
  ...
  return (
    <div className="min-h-screen">
      <DeptHero
        ...
        imageSrc="/caes.jpg"
        imageAlt="Civil Engineering Cover Image"
        description="Welcome to the Civil Engineering department. Explore our events here."
      />
