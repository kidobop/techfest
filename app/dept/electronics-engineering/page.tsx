...
import EventCard from "@/components/EventCardEL";
  ...
  return (
    <div className="min-h-screen">
      <DeptHero
        ...
        imageSrc="/elsa.jpg"
        imageAlt="Electronics Engineering Cover Image"
        description="Welcome to the Electronics Engineering department. Explore our events here."
      />
